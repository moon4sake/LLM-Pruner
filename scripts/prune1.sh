...
do
    prune_ckpt_path=Qwen2.5-Math-1.5B_s${sparsity}_block
    tune_ckpt_path=Qwen2.5-Math-1.5B_s${sparsity}_block

    echo "[START] - Start Pruning Model"
    CUDA_VISIBLE_DEVICES=1 python llama3.py --base_model Qwen/Qwen2.5-Math-1.5B \
