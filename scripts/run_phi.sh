...
run_pipeline() {
    ...
    if ! (echo y | CUDA_VISIBLE_DEVICES=${gpu_id} python llama3.py --base_model ${base_model} \
        ...
        --block_mlp_layer_start 0 --block_mlp_layer_end 32 --block_attention_layer_start 0 \
        --block_attention_layer_end 32 --save_ckpt_log_name ${prune_ckpt_path} --pruner_type taylor \
