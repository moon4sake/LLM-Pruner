# prune_ckpt_path='DeepSeek-R1-Distill-Llama-8B_s0.25'
# tune_ckpt_path='DeepSeek-R1-Distill-Llama-8B_s0.25'

# echo "[START] - Start Pruning Model"
# CUDA_VISIBLE_DEVICES=2 python llama3.py --base_model deepseek-ai/DeepSeek-R1-Distill-Llama-8B \
#                                         --pruning_ratio 0.25 \
...
prune_ckpt_path='Qwen2.5-Math-1.5B_s0.5'
tune_ckpt_path='Qwen2.5-Math-1.5B_s0.5'

echo "[START] - Start Pruning Model"
CUDA_VISIBLE_DEVICES=2 python llama3.py --base_model Qwen/Qwen2.5-Math-1.5B \
                                        --pruning_ratio 0.5 \
                                        --device cuda --eval_device cuda \
                                        --block_wise --block_mlp_layer_start 4 --block_mlp_layer_end 30 \
                                        --block_attention_layer_start 4 --block_attention_layer_end 30 \
...
prune_ckpt_path='DeepSeek-R1-Distill-Qwen-1.5B_s0.5'
tune_ckpt_path='DeepSeek-R1-Distill-Qwen-1.5B_s0.5'

echo "[START] - Start Pruning Model"
CUDA_VISIBLE_DEVICES=2 python llama3.py --base_model deepseek-ai/DeepSeek-R1-Distill-Qwen-1.5B \
                                        --pruning_ratio 0.5 \
                                        --device cuda --eval_device cuda \
                                        --block_wise --block_mlp_layer_start 4 --block_mlp_layer_end 30 \
                                        --block_attention_layer_start 4 --block_attention_layer_end 30 \
