prune_ckpt_path='Llama-3.1-8B_s0.10_block'
tune_ckpt_path='Llama-3.1-8B_s0.10_block'

echo "[START] - Start Pruning Model"
CUDA_VISIBLE_DEVICES=2 python llama3.py --base_model meta-llama/Llama-3.1-8B \
                                        --pruning_ratio 0.10 \
...
prune_ckpt_path='DeepSeek-R1-Distill-Llama-8B_s0.10_block'
tune_ckpt_path='DeepSeek-R1-Distill-Llama-8B_s0.10_block'
...
# do
#     prune_ckpt_path=Llama-3.1-8B_s${sparsity}_channel
#     tune_ckpt_path=Llama-3.1-8B_s${sparsity}_channel
