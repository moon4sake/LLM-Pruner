...
do
    ...
    CUDA_VISIBLE_DEVICES=3 python llama3.py --base_model deepseek-ai/DeepSeek-R1-Distill-Qwen-1.5B \
...
do
    ...
    echo "[START] - Start Pruning Model"
    CUDA_VISIBLE_DEVICES=3 python llama3.py --base_model Qwen/Qwen2.5-Math-1.5B \
                                            --pruning_ratio ${sparsity} \
                                            --device cuda --eval_device cuda \
                                            --channel_wise \
                                            --save_ckpt_log_name $prune_ckpt_path \
...
# for sparsity in ${sparsity_list}
# do
#     prune_ckpt_path=DeepSeek-R1-Distill-Llama-8B_s${sparsity}_channel
#     tune_ckpt_path=DeepSeek-R1-Distill-Llama-8B_s${sparsity}_channel

#     echo "[START] - Start Pruning Model"
#     CUDA_VISIBLE_DEVICES=3 python llama3.py --base_model deepseek-ai/DeepSeek-R1-Distill-Llama-8B \
#                                             --pruning_ratio ${sparsity} \
#                                             --device cuda --eval_device cuda \
#                                             --channel_wise --num_examples 5\
#                                             --save_ckpt_log_name $prune_ckpt_path \
#                                             --pruner_type taylor --taylor param_first \
#                                             --max_seq_len 2048 \
#                                             --test_after_train --save_model #--test_before_train
...
# prune_ckpt_path='DeepSeek-R1-Distill-Llama-8B_s0.10'
# tune_ckpt_path='DeepSeek-R1-Distill-Llama-8B_s0.10'

# echo "[START] - Start Pruning Model"
# # CUDA_VISIBLE_DEVICES=0 python llama3.py --base_model meta-llama/DeepSeek-R1-Distill-Llama-8B \
# #                                         --pruning_ratio 0.25 \
# #                                         --device cuda --eval_device cuda \
