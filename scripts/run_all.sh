...
run_pipeline() {
    ...
    if ! (echo y | CUDA_VISIBLE_DEVICES=${gpu_id} python llama3.py --base_model ${base_model} \
        ...
        --block_mlp_layer_start 4 --block_mlp_layer_end 16 --block_attention_layer_start 4 \
        --block_attention_layer_end 16 --save_ckpt_log_name ${prune_ckpt_path} --pruner_type taylor \
    ...
    echo y | CUDA_VISIBLE_DEVICES=${gpu_id} python post_training.py --prune_model prune_log/${prune_ckpt_path}/pytorch_model.bin \
        ...
        --wandb_project DistillPrune --lora_r 8 --num_epochs 4 \
