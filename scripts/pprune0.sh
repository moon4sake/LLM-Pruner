prune_ckpt_path='DeepSeek-R1-Distill-Qwen-7B_s0.10'
tune_ckpt_path='DeepSeek-R1-Distill-Qwen-7B_s0.10'

echo "[START] - Start Pruning Model"
CUDA_VISIBLE_DEVICES=0 python llama3.py --base_model deepseek-ai/DeepSeek-R1-Distill-Qwen-7B \
                                        --pruning_ratio 0.10 \
