    ...
    if args.block_wise or args.channel_wise:
        ...
        root_instances = (
            [
                ...
                for i in range(
                    args.block_attention_layer_start, args.block_attention_layer_end
                )
            ]
            + [
        ...
        logger.log(
            "Pruning MLP Layer = {}".format(
                list(range(args.block_mlp_layer_start, args.block_mlp_layer_end))
            )
        )
        ...
        for i in range(args.iterative_steps):
            ...
            if pruner_type in ["taylor"]:
                ...
                example_prompts = get_examples(
                    "bookcorpus", tokenizer, args.num_examples, seq_len=args.max_seq_len
                ).to(args.device)
                """
...
if __name__ == "__main__":
    ...
    parser.add_argument("--pruner_seq_len", type=int, default=128, help="pruner type")
